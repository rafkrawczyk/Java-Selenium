...
public class SampleExtentReport {
	...
	public void sampleReport() {
		...
		spark.config().setReportName("My_Sample_Report");
		spark.config().setDocumentTitle("My First Extent Report");
		extent.attachReporter(spark);
		
		ExtentTest loginTest = extent.createTest("Instagram Login Test");
		...
		ExtentTest homePageTest = extent.createTest("Instagram Homepage Test");
		homePageTest.pass("Enter Instagram Homepage");
